...
Demo Web Shop Functional Test Case Generator

## Purpose

Generate comprehensive, structured, and automation-ready functional test cases for the Demo Web Shop application (https://demowebshop.tricentis.com/) using manual QA best practices combined with AI-assisted test design.

---

## Instructions

1. Analyze the application URL, feature, user story, requirement, or business flow.
2. Identify all functional modules available in the application.
...
4. Generate detailed test cases for the following modules:
...
5. Every test case should contain:
   ...
   * Test Type
   * Priority
6. Ensure that each test case has only one testing objective.
7. Make the generated test cases suitable for future Selenium, Playwright, or Cypress automation.
...
Generate automation-ready test cases using the following format:

| Field           | Description                                        |
| --------------- | -------------------------------------------------- |
| Test Case ID    | Unique Identifier (Example: TC_DWT_001)            |
...
| Test Type       | Functional / Negative / Boundary / UI / Regression |
...
* Follow QA industry best practices.
...
* Do not assume functionality that is not available in the application.
* Keep UI validation separate from functional validation whenever possible.
* Ensure generated test cases are automation-friendly.

---

## Automation Guidelines

Generated test cases should be compatible with:
...
Automation-ready test cases should:

* Have reusable steps
* Include clear assertions
* Support data-driven execution
...
The generated output should cover:
...
✓ Responsive Tablet Validation

---

## Quality Checklist

Before generating the final test cases, verify that:

* Every functional module is covered.
* No duplicate scenarios exist.
* Test case IDs are unique.
* Preconditions are included where necessary.
* Test steps are sequential and easy to execute.
* Expected results are clearly defined.
* Priority is assigned.
* Test type is assigned.
* Business flows are completely validated.
* Test cases are suitable for manual execution.
* Test cases are ready for automation.
