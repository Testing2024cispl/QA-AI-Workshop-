...
Module	Total TCs	P1	P2	P3	Negative / BVA
Registration	8	4	3	1	6
Login	8	4	3	1	4
Search	7	1	4	2	3
Product	8	2	4	2	4
Cart	7	3	4	0	2
...
Legend — Priority	Legend — Test Type
P1 — Critical  — Must pass; blocks release	P2 — High  — Should pass; major feature risk
P3 — Medium  — Nice to verify; low business risk	Positive  — Happy path / valid input
Negative  — Invalid input / error handling	BVA  — Boundary Value Analysis
Exploratory  — Session, UX, security probing	
