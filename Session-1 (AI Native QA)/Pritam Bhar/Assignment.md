...
Enter a valid First Name, Last Name, Username, Email, Password, Confirm Password, and Phone Number
Click the "Register" button
Verify the success message/pop-up is displayed
Verify user is registered and can log in with the same credentials
